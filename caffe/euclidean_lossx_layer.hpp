#ifndef CAFFE_EUCLIDEAN_LOSSX_LAYER_HPP_
#define CAFFE_EUCLIDEAN_LOSSX_LAYER_HPP_
 ...
 * input to a EuclideanLossXLayer exactly formulates a linear least squares
 ...
 * Compare to EuclideanLossLayer, EuclideanLossXLayer support ignore label.
 */
template <typename Dtype>
class EuclideanLossXLayer : public LossLayer<Dtype> {
 public:
  explicit EuclideanLossXLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "EuclideanLossX"; }
  /**
   * Unlike most loss layers, in the EuclideanLossXLayer we can backpropagate
 ...
 protected:
   ...
   *
   * Unlike other children of LossLayer, EuclideanLossXLayer \b can compute
...
#endif  // CAFFE_EUCLIDEAN_LOSSX_LAYER_HPP_
